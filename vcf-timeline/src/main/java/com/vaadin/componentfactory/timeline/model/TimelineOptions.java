...
public class TimelineOptions {
	...
	/*
	 * Specifies whether the Timeline can be zoomed by pinching or scrolling in the window. Only applicable when option
	 * moveable is true.
	 */
	...
	/*
	 * The height of the timeline in pixels or as a percentage. When height is undefined or null, the height of the
	 * timeline is automatically adjusted to fit the contents.
	 */
	...
	/*
	 * If true, multiple items can be selected using ctrl+click, shift+click, or by holding items. Only applicable when
	 * option selectable is true.
	 */
	...
	public String toJSON() {
		...
		final JsonObject orientationJs = Json.createObject();
		...
		Optional.ofNullable(tooltipOnItemUpdateTimeDateFormat)
				.ifPresent(v -> js.put("tooltipOnItemUpdateTimeDateFormat", v.toString()));
		Optional.ofNullable(tooltipOnItemUpdateTimeTemplate)
				.ifPresent(v -> js.put("tooltipOnItemUpdateTimeTemplate", v.toString()));
